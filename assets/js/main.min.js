...
(function () {
  ...
  function initTheme() {
    ...
    function applyTheme(theme, persist) {
      ...
      if (themeColor) themeColor.setAttribute("content", isDark ? "#0b111b" : "#ffffff");

      if (persist) {
        try { window.localStorage.setItem("site-theme", isDark ? "dark" : "light"); } catch (error) {}
      }
    }
